...
func testMatchRecord(stage string) *core.Record {
	...
	collection.Fields.Add(&core.TextField{Name: "homeLabel", Max: 32})
	collection.Fields.Add(&core.TextField{Name: "awayLabel", Max: 32})
	collection.Fields.Add(&core.TextField{Name: "groupLetter", Max: 4})
	collection.Fields.Add(&core.TextField{Name: "penWinner", Max: 32})
	collection.Fields.Add(&core.TextField{Name: "advancer", Max: 32})
	collection.Fields.Add(&core.NumberField{Name: "num", OnlyInt: true})
